...
var rootCmd = &cobra.Command{
	Use:     "dtools",
	Short:   "Docker client",
	Version: hf.White(fmt.Sprintf("0.80.00-0-%s (2024.05.20)", runtime.GOARCH)),
...
-------			----			-------
00.80.00		2024.05.20		Moved all functions from the helpers package to my github helperFunctions package
